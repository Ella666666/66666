================================================================================
    MICROSOFT 基础类库 : 421exp1 项目概述
===============================================================================

应用程序向导已为您创建了此 421exp1 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 421exp1 应用程序的每个文件的内容。

421exp1.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，其中包含生成该文件的 Visual C++ 的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

421exp1.vcxproj.filters
...
res\421exp1.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 421exp1.rc 中。
...
421exp1Dlg.h、421exp1Dlg.cpp - 对话框
    这些文件包含 CMy421exp1Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 421exp1.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 421exp1.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
