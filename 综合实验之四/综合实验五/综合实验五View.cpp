...
BEGIN_MESSAGE_MAP(C综合实验五View, CRecordView)
	...
	ON_COMMAND(ID_Add, &C综合实验五View::OnAdd)
	ON_COMMAND(ID_Delete, &C综合实验五View::OnDelete)
	ON_COMMAND(ID_Modi, &C综合实验五View::OnModi)
END_MESSAGE_MAP()
